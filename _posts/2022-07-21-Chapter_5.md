...
![Q2_Lab05-01.dll](assets/img/Chapter 5/Lab05-01.dll/Q2_Lab05-01.dll)
...
![Q3_Lab05-01.dll](assets/img/Chapter 5/Lab05-01.dll/Q3_Lab05-01.dll)  
...
![Q4_Lab05-01.dll](assets/img/Chapter 5/Lab05-01.dll/Q4_Lab05-01.dll)
...
![Q5_Lab05-01.dll](assets/img/Chapter 5/Lab05-01.dll/Q5_Lab05-01.dll)
...
![Q7_Lab05-01.dll](assets/img/Chapter 5/Lab05-01.dll/Q7_Lab05-01.dll)
				Figure 7
...
![Figure 8.1](assets/img/Chapter 5/Lab05-01.dll/Q7.2_Lab05-01.dll)
...
![Figure 8.2](assets/img/Chapter 5/Lab05-01.dll/Q7.3_Lab05-01.dll)
...
![Figure 9.1](assets/img/Chapter 5/Lab05-01.dll/Q9.1.Lab05-01.dll)

In Figure 9.2 we went to the first reference, for the "w" type which stands for write, 

![Figure 9.2](assets/img/Chapter 5/Lab05-01.dll/Q9.2.Lab05-01.dll)
...
![Figure 9.3](assets/img/Chapter 5/Lab05-01.dll/Q9.3_Lab05-01.dll)
...
![Figure 10.1](assets/img/Chapter 5/Lab05-01.dll/Q10.1_Lab05-01.dll)

This leads us to the following block of commands in Figure 10.2:

![Figure 10.2](assets/img/Chapter 5/Lab05-01.dll/Q10.2_Lab05-01.dll)

The subroutine _sub_100052A2_ is called so let's follow it. The subroutine can be seen in Figure 10.3.

![Figure 10.3](assets/img/Chapter 5/Lab05-01.dll/Q10.3_Lab05-01.dll)
...
![Figure 11.1](assets/img/Chapter 5/Lab05-01.dll/Q11.1_Lab05-01.dll)

In the bottom part of the code, a call to the subroutine _sub100036C3_ is being made. Let's look into that in Figure 11.2!

![Figure 11.2](assets/img/Chapter 5/Lab05-01.dll/Q11.2_Lab05-01.dll)
...
![Figure 11.3](assets/img/Chapter 5/Lab05-01.dll/Q11.3_Lab05-01.dll)
...
![Figure13.1](assets/img/Chapter 5/Lab05-01.dll/Q13.1_Lab05-01.dll)
...
![Figure 13.2](assets/img/Chapter 5/Lab05-01.dll/Q13.2_Lab05-01.dll)

![Figure 13.3](assets/img/Chapter 5/Lab05-01.dll/Q13.2_Lab05-01.dll)

![Figure 13.4](assets/img/Chapter 5/Lab05-01.dll/Q13.2_Lab05-01.dll)
...
![Figure 14.1](assets/img/Chapter 5/Lab05-01.dll/Q14.1-Lab05-01.dll)
...
![Figure 15.1](assets/img/Chapter 5/Lab05-01.dll/Q15.1_Lab05-01.dll)
...
![Figure 17.2](assets/img/Chapter 5/Lab05-01.dll/Q17.2_Lab05-01.dll)

![Figure 17.3](assets/img/Chapter 5/Lab05-01.dll/Q17.3_Lab05-01.dll)
...
![Figure 17.4](assets/img/Chapter 5/Lab05-01.dll/Q17.4_Lab05-01.dll)

> 18.Jump your cursor to 0x1001D988. What do you find?

At _0x1001D988_ is the beggining of what looks like a string (Figure 18.1).

![Figure 18.1](assets/img/Chapter 5/Lab05-01.dll/Q18.1_Lab05-01.dll)
...
[Figure 19.1](assets/img/Chapter 5/Lab05-01.dll/Q19.1_Lab05-01.dll)
...
![Figure 21.1](assets/img/Chapter 5/Lab05-01.dll/Q21.1_Lab05-01.dll)
